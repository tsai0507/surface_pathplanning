...
main (int argc, char** argv)
{
  ...
  writer.write<pcl::PointXYZ> ("out.pcd", *cloud_filtered, false);
  ...
  while (cloud_filtered->size () > 0.3 * nr_points)
  {
    ...
    vis3.addPointCloud<pcl::PointXYZ> (cloud_p);
    // vis3.addPointCloudNormals<pcl::PointXYZ> (cloud_p, 5, 0.2f, "cloud_normals");
